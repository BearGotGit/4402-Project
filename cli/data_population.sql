...
INSERT OR IGNORE INTO PLAN (PlanID, Name, Price, Calories, Frequency, NumberOfMeals)
VALUES 
    (1, 'Basic Plan', 29.99, 2000, 3, 15),
    (2, 'Value Plan', 39.99, 2500, 4, 20),
    (3, 'Premium Plan', 59.99, 3000, 5, 25);

-- Insert into DRIVER table
INSERT OR IGNORE INTO DRIVER (FirstName, LastName, ZipCode, RatePerMile, SumOfTips, SumOfMiles)
VALUES 
    ('Alice', 'Smith', 12345, 0.85, 200.50, 1500),
    ('Bob', 'Johnson', 67890, 0.90, 150.75, 1200);

-- Insert into Warehouse table
INSERT OR IGNORE INTO Warehouse (WarehouseAddress)
VALUES 
    ('100 Warehouse Ave'),
    ('200 Storage Blvd');

-- Insert into Ingredient table
INSERT OR IGNORE INTO INGREDIENT (Name, Description, Price, Count, WarehouseID)
VALUES 
...
INSERT OR IGNORE INTO Employee (FirstName, LastName, Department, Salary)
VALUES 
    ('John', 'Doe', 'Sales', 55000.00),
    ('Jane', 'Williams', 'Marketing', 60000.00);

-- Insert into USER_TABLE
INSERT OR IGNORE INTO USER_TABLE (Phone, Email, Password, FirstName, LastName, Address, PlanID, PaymentInfo)
VALUES 
...
INSERT OR IGNORE INTO ADDRESS (Country, City, State, ZipCode, UserID)
VALUES 
    ('USA', 'New York', 'NY', 10001, 1),
    ('USA', 'Los Angeles', 'CA', 90001, 2);

-- Insert into Item table
INSERT OR IGNORE INTO Item (ItemName, ItemDescription, Price, Count, WarehouseID)
VALUES 
...
INSERT OR IGNORE INTO RECIPE (IngredientID, Calories, RecipeName, RecipeDescription, Price, Count, WarehouseID)
VALUES 
...
INSERT OR IGNORE INTO Invoice (UserID, DriverID, RecipeID, InvoiceDate)
VALUES 
    (1, 1, 1, '2023-10-01'),
    (2, 2, 3, '2023-10-02');